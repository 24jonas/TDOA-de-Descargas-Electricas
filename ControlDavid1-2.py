...
pin = 16 #Pin a usar para el IRQ
sensor = RPi_AS3935(address=0x03, bus=3) #Dirección del sensor
noise = 0
a = True
#----------Calibración----------#
...
f = open("datos1.txt","a") #Apertura de archivo de datos
...
#------------Modo de Monioreo------------------#    
    ...
    while True:
        ...
        sensor.__init__(address=0x03, bus=3)
